...
def shopify_install():
    ...
    auth_url = f"https://{SHOPIFY_STORE_URL}/admin/oauth/authorize?client_id={SHOPIFY_CLIENT_ID}&scope=read_products,read_inventory,write_products,write_orders&redirect_uri=https://saygin-entegrasyon.onrender.com/shopify/callback"
